...
{
	internal sealed class BuildServerWin64Command
	{
		...
		private BuildServerWin64Command(AsyncPackage package, IMenuCommandService commandService)
		{
		...
		public static BuildServerWin64Command Instance
		{
			get;
			private set;
		}
		...
		public static async Task InitializeAsync(AsyncPackage package)
		{
			...
			Instance = new BuildServerWin64Command(package, commandService);
		}
		...
		private void Execute(object sender, EventArgs e)
		{
			this.package.JoinableTaskFactory.RunAsync(async () =>
			{
				...
				await BuildProjectWithConfigurationAsync("Shipping Server", "FactoryGame", "Win64");
			});
		}
		...
		private async Task BuildProjectWithConfigurationAsync(string configurationName, string projectName, string targetPlatform)
		{
			...
			try
			{
				...
				{
					buildEventManager.RegisterBuild(projectName, "Build Win Server");
				}
