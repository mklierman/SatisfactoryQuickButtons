...
{
	internal sealed class BuildServerLinuxCommand
	{
		...
		private BuildServerLinuxCommand(AsyncPackage package, IMenuCommandService commandService)
		{
		...
		public static BuildServerLinuxCommand Instance
		{
			get;
			private set;
		}
		...
		public static async Task InitializeAsync(AsyncPackage package)
		{
			...
			Instance = new BuildServerLinuxCommand(package, commandService);
		}
		...
		private void Execute(object sender, EventArgs e)
		{
			this.package.JoinableTaskFactory.RunAsync(async () =>
			{
				...
				await BuildProjectWithConfigurationAsync("Shipping Server", "FactoryGame", "Linux");
			});
		}
		...
		private async Task BuildProjectWithConfigurationAsync(string configurationName, string projectName, string targetPlatform)
		{
			...
			try
			{
				...
				{
					buildEventManager.RegisterBuild(projectName, "Build Linux Server");
				}
