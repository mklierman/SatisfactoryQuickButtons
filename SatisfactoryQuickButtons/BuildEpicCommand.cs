...
{
	internal sealed class BuildEpicCommand
	{
		...
		private BuildEpicCommand(AsyncPackage package, IMenuCommandService commandService)
		{
		...
		public static BuildEpicCommand Instance
		{
			get;
			private set;
		}
		...
		public static async Task InitializeAsync(AsyncPackage package)
		{
			...
			Instance = new BuildEpicCommand(package, commandService);
		}
		...
		private void Execute(object sender, EventArgs e)
		{
			this.package.JoinableTaskFactory.RunAsync(async () =>
			{
				...
				await BuildProjectWithConfigurationAsync("Shipping", "FactoryGameEGS");
			});
		}
		...
		private async Task BuildProjectWithConfigurationAsync(string configurationName, string projectName)
		{
			...
			try
			{
				...
				{
					buildEventManager.RegisterBuild(projectName, "Build Epic");
				}
