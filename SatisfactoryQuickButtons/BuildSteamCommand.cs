...
{
	internal sealed class BuildSteamCommand
	{
		...
		private BuildSteamCommand(AsyncPackage package, IMenuCommandService commandService)
		{
		...
		public static BuildSteamCommand Instance
		{
			get;
			private set;
		}
		...
		public static async Task InitializeAsync(AsyncPackage package)
		{
			...
			Instance = new BuildSteamCommand(package, commandService);
		}
		...
		private void Execute(object sender, EventArgs e)
		{
			this.package.JoinableTaskFactory.RunAsync(async () =>
			{
				...
				await BuildProjectWithConfigurationAsync("Shipping", "FactoryGameSteam");
			});
		}
		...
		private async Task BuildProjectWithConfigurationAsync(string configurationName, string projectName)
		{
			...
			try
			{
				...
				{
					buildEventManager.RegisterBuild(projectName, "Build Steam");
				}
